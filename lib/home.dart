...
class _HomeState extends State<_Home> {
  ...
  Widget build(BuildContext context) {
    List<NameIconFunction> menu = [
      ...
      NameIconFunction(LocaleKeys.homeLegal.tr(), LocaleKeys.homeLegalText.tr(), Icons.privacy_tip, () => launchUrl(Uri.parse(LocaleKeys.homeLegalLink.tr()))),
    ];
    return Scaffold(
      body: SafeArea(
        top: false,
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Padding(padding: const EdgeInsets.only(left: 20, top: 40), child: Image.asset("assets/logo.png", scale: 8)),
                        Padding(
